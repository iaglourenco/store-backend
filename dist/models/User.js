...
let User = (_dec = (0, _typeorm.Entity)("users"), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)("uuid", {
  name: "id"
  ...
  name: "user_id"
}), _dec24 = Reflect.metadata("design:type", Array), _dec(_class = (_class2 = class User {
  constructor() {
    ...
    _initializerDefineProperty(this, "reviews", _descriptor7, this);

    _initializerDefineProperty(this, "products", _descriptor8, this);
  }
  ...
  writable: true,
  initializer: null
}), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "buyRecords", [_dec16, _dec17, _dec18], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "reviews", [_dec19, _dec20, _dec21], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "products", [_dec22, _dec23, _dec24], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
